...
static const unsigned short STATE_LENGTH{ 200u };
static const unsigned short ADDRESS_LENGTH{ 20u };
static const unsigned short UINT256_LENGTH{ 32u };
static const unsigned short PREFIX_LENGTH{ ADDRESS_LENGTH + UINT256_LENGTH };
static const unsigned short MESSAGE_LENGTH{ PREFIX_LENGTH + UINT256_LENGTH };
